				  ...
				  const struct sdio_device_id *id)
{
	...
	struct wl1251_platform_data *wlan_data;
...
/*
	...
	if (ret)
		goto out_free_glue;
*/
	wlan_data = wl1251_get_platform_data();
	if (IS_ERR(wlan_data)) {
	...
	irq = wlan_data->irq;
	pdev_data.ref_clock_freq = wlan_data->ref_clock_freq;
	pdev_data.tcxo_clock_freq = wlan_data->tcxo_clock_freq;
