...
#define DEFAULT_HOTPLUG_IN_LOAD			(98)
#define DEFAULT_HOTPLUG_OUT_LOAD		(4)
#define DEFAULT_DIFFERENTIAL			(10)

#define DEFAULT_SAMPLING_PERIOD			(30000)
/* 0s booting not hotplug */
#define BOOTING_SAMPLING_PERIOD			(0)
...
#define TASK_THRESHOLD_L				(100)

/*CPU NUM WATERSHED*/
#define CPU_NUM_WATERSHED				(1)
