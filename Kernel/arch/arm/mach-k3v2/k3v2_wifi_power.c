...
#ifdef CONFIG_WILINK_PLATFORM_DATA
static struct wl1251_platform_data k3v2_wlan_data __initdata = {
	.power_gpio = K3V2_WIFI_POWER_GPIO,
	.irq = 0,
	.ref_clock_freq = WL12XX_REFCLOCK_26,
	.tcxo_clock_freq = WL12XX_TCXOCLOCK_26,
};
#else
...
#ifdef CONFIG_WILINK_PLATFORM_DATA
	pr_info("TI WL18XX: wl1251_set_platform_data\n");
	wl1251_set_platform_data(&k3v2_wlan_data);
#else
	pr_info("TI WL18XX: wl125xxset_platform_data\n");
