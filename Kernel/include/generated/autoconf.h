...
#define CONFIG_PMEM_OVERLAY_SIZE 72
...
#define CONFIG_PMEM_GRALLOC_SIZE 90
...
#define CONFIG_CPU_DEFAULT_FREQ 1500000
...
#define CONFIG_LOG_TO_EXCEPTION 1
...
#define CONFIG_CPU_MAX_FREQ 1700000
...
#define CONFIG_CMDLINE "androidboot.hardware=k3v2oem1 vmalloc=384M k3v2_pmem=1 mmcparts=mmcblk0:p1(xloader),p3(nvme),p4(misc),p5(splash),p6(oeminfo),p7(reserved1),p8(reserved2),p9(splash2),p10(recovery2),p11(recovery),p12(boot),p13(modemimage),p14(modemnvm1),p15(modemnvm2),p16(system),p17(cache),p18(cust),p19(userdata);mmcblk1:p1(ext_sdcard)"
...
#define CONFIG_PARTIAL_UPDATES 1
